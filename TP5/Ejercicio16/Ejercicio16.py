...
for i, (prob_priori, matriz_canal) in enumerate(zip(probs_lista, matrices_lista), start=1):    
    ...
    print(f"a) Entropia a Priori H(A):")
    ...
    print(f"f) Informacion mutua H(A, B):")
